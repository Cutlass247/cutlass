...
- **One long video → many shorts.** Auto-split a recording into short-ready clips at natural breaks.
- **Captions in one click.** On-device transcription, then burned-in captions timed to your speech.
...
2. **+ Import** a clip. Choose **Fill** (full-bleed) or **Blur bg**, and pan to frame your subject.
3. Click **✨ Add captions** — it transcribes on-device and burns in captions.
4. **Export** your clip. Done.
