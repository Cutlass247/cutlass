...
fn main() -> anyhow::Result<()> {
    ...
    let rate = 48_000u32;
    let t1 = vec![AudioClip { path: path.clone(), start: 0.0, len: 1.0, src_in: 0.0, volume: 1.0, speed: 1.0 , audio_offset: 0.0 }];
    let t2 = vec![AudioClip { path, start: 1.0, len: 1.0, src_in: 5.0, volume: 1.0, speed: 1.0 , audio_offset: 0.0 }];
